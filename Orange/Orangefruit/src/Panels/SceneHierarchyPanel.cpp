...
namespace Orange
{
	...
	void SceneHierarchyPanel::DrawEntityNode(Entity entity)
	{
		...
		if (entityDeleted)
		{
			o_Context->DestroyEntity(entity);
			if (o_SelectionContext == entity)
				o_SelectionContext = {};
		}
	}
	...
	void SceneHierarchyPanel::DrawComponents(Entity entity)
	{
		...
		DrawComponent<ScriptComponent>("Script", entity, [entity, scene = o_Context](auto& component) mutable
			{
	...
	void SceneHierarchyPanel::DisplayAddComponentEntry(const std::string& entryName) {
		if (!o_SelectionContext.HasComponent<T>())
		{
			if (ImGui::MenuItem(entryName.c_str()))
			{
				o_SelectionContext.AddComponent<T>();
