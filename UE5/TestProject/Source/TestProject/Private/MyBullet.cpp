...
AMyBullet::AMyBullet()
{
	...
	MyBullet = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("MyBullerComponent"));
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> TmpStaticMesh(TEXT("/Script/Engine.StaticMesh'/Game/StarterContent/Shapes/Shape_Cone.Shape_Cone'"));
